 ...
 */
public class Chapter6Methods1Screen implements Screen {
    ...
    public Chapter6Methods1Screen(Screen parent, String function, Integer numberOfVariables) {
        this.parent = parent;
...
//            table.add().colspan(0).height(Util.multiplyToWorldFactor(20));
    ...
    private void calculating() {
        ...
        int input4 = Gdx.app.getPreferences("NumericalMethodsProject").getInteger("floating point digits");
        MatlabEngine engine = ((Project) Gdx.app.getApplicationListener()).getEngine();
        String method = null;
//        "Inverse matrix", "Cramer", "Gausse Elimination", "LU Doolittle", "LU Cholesky",
//                "LU Crout"
        if (function.equals("Inverse matrix")){
            method = "inverseMatrix";
        } else if (function.equals("Cramer")) {
            method = "cramer";
        } else if (function.equals("Gausse Elimination")) {
            method = "gausseElimination";
        } else if (function.equals("LU Doolittle")) {
            method = "LUDoolittle";
        } else if (function.equals("LU Cholesky")) {
            method = "LUCholesky";
        } else if (function.equals("LU Crout")) {
            method = "LUCrout";
        }
        try {
            Object[] result = engine.feval(2, method, input1,input2,input3, input4);
    ...
    public void createFieldsOfPoints() {
