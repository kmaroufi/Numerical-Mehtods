...
public class Chapter2Screen implements Screen {
    ...
    public Chapter2Screen(Screen parent) {
        this.parent = parent;
    }
...
//        table.setBackground(new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("background4.jpg")))));
        ...
        Cell methodsCell =  table.add().height(Util.multiplyToWorldFactor(50)).colspan(12);
        {
...
//            scrollPaneStyle.hScroll = new TextureRegionDrawable(new TextureRegion(new Texture("hScroll.png")));
            ...
            selectBox.setItems(new String[]{"Bisection", "False position", "Secant", "Newton-Raphson", "Fixed point", "Generalized Newton-Raphson"});
    ...
    private void openRelatedScreen() {
        ...
        switch (index) {
            ...
            case 1:
            case 2:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter2Methods1Screen(Chapter2Screen.this, (String)selectBox.getSelected()));
                break;
            case 3:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter2NewtonRaphsonScreen(Chapter2Screen.this, (String)selectBox.getSelected()));
                break;
            case 4:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter2FixedPointScreen(Chapter2Screen.this, (String)selectBox.getSelected()));
                break;
            case 5:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter2GeneralizedGetNumberScreen(Chapter2Screen.this, (String)selectBox.getSelected()));
        }
