 ...
 */
public class Chapter2NewtonRaphsonScreen implements Screen {
    ...
    public Chapter2NewtonRaphsonScreen(Screen parent, String method) {
        this.parent = parent;
        this.method = method;
    }
...
//        table.setBackground(new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("background4.jpg")))));
    ...
    public void calculating() {
        ...
        try {
            String methodName = "newtonRaphson";
            Object[] object = engine.feval(3,  methodName, input1,input2);
    ...
    private void showResult(boolean isRootFinded, double root) {
        if (isRootFinded) {
            ...
            resultLabel.setText("Root was not found. Check your initial point or \n maybe your chosen method is not appropriate.");
        }
    }
