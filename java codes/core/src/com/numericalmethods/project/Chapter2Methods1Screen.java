 ...
 */
public class Chapter2Methods1Screen implements Screen {
    ...
    public Chapter2Methods1Screen(Screen parent, String method) {
        this.parent = parent;
        this.method = method;
    }
...
//        table.setBackground(new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("background4.jpg")))));
    ...
    public void calculating() {
        ...
        try {
            ...
            Object[] object = engine.feval(3,  methodName, input1,input2,input3);
