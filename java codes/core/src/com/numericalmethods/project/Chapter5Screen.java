 ...
 */
public class Chapter5Screen implements Screen {
    ...
    public Chapter5Screen(Screen parent) {
        this.parent = parent;
    }
...
//        table.setBackground(new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("background4.jpg")))));
        ...
        {
            Label.LabelStyle labelStyle = new Label.LabelStyle(font, Color.BLACK);
            Label label = new Label("Choose your ODE's order :  ", labelStyle);
...
//            scrollPaneStyle.hScroll = new TextureRegionDrawable(new TextureRegion(new Texture("hScroll.png")));
            ...
            selectBox.setItems(new String[]{"First Order ODE", "Second Order ODE"});
    ...
    private void openRelatedScreen() {
        ...
        switch (index) {
            case 0:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter5FirstOrderScreen(Chapter5Screen.this));
                break;
            case 1:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter5SecondOrderScreen(Chapter5Screen.this));
        }
