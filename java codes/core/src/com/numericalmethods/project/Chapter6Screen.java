...
public class Chapter6Screen implements Screen {
    ...
    public Chapter6Screen(Screen parent) {
        this.parent = parent;
    }
...
//            scrollPaneStyle.hScroll = new TextureRegionDrawable(new TextureRegion(new Texture("hScroll.png")));
            ...
            selectBox.setItems(new String[]{"Solving a system of equations", "Calculate eigenvalues"});
    ...
    private void openRelatedScreen() {
        ...
        switch (index) {
            case 0:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter6SelectingMethodsScreen(Chapter6Screen.this));
                break;
            case 1:
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Chapter6GetRowsScreen(Chapter6Screen.this));
        }
